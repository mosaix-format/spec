...
window.MOSAIX_VAULT = [
/* ---------- MOC ---------- */
{path:"Home.md",title:"Home",id:"01JVTQ8YBNKRMWBDHF3QPGTNYV",type:"moc",tags:["moc"],updated:"2026-09-05",
...
/* ---------- meta ---------- */
{path:"_meta/Conventions.md",title:"Conventions",id:"01JVTQ8YBNDHFMVWXKBNPQRYGT",type:"meta",tags:["moc","meta","ledger","synthesis","people","product","bread","pastry","seasonal","supplier","market","neighbourhood","competitor","event","operations","equipment","policy","decision","composed-document"],updated:"2026-09-05",
 ...
 body:"mosaix: \"1.1\". Folders: `01-People/` who the partners are, `02-Products/` what the bakery sells, `03-Suppliers/` who provides the ingredients, `04-Market/` where they sell and who competes, `05-Operations/` how the bakery runs, `06-Decisions/` choices that shape the business. Reserved: `_meta/`, `_synthesis/`, `_docs/`.\n\nReliability: frontmatter key `status` with values sourced · to-confirm · superseded. Domain keys: `season` (spring, summer, autumn, winter), `channel` (shop, market, wholesale). Entity type added: `recipe`. Relation types: supplies, owns, sells at, competes with, depends on.\n\nTags declared: the `tags` list of this note is the taxonomy. Maintainers: E. Nordgren (products), M. Trevisan (operations). Map of content: [[Home]]. Ledger: [[Open questions]]."},

{path:"_meta/Open questions.md",title:"Open questions",id:"01JVTQ8YBNYWKVPGRNBXQFTHDM",type:"ledger",tags:["meta","ledger"],updated:"2026-09-05",
...
/* ---------- synthesis ---------- */
{path:"_synthesis/Forno Vialetto in one page.md",title:"Forno Vialetto in one page",id:"01JVTQ8YBNBFRMTXVWDKNQHPYG",type:"synthesis",tags:["synthesis"],updated:"2026-09-05",
...
/* ---------- 01-People ---------- */
{path:"01-People/Elsa Nordgren.md",title:"Elsa Nordgren",id:"01JVTQ8YBNQTNHXBKDMFVWRPYG",type:"person",tags:["people"],updated:"2026-09-05",
...
{path:"01-People/Marco Trevisan.md",title:"Marco Trevisan",id:"01JVTQ8YBNMKQBDPFNTHWVRGXY",type:"person",tags:["people"],updated:"2026-09-05",
...
{path:"01-People/Layla Beshir.md",title:"Layla Beshir",id:"01JVTQ8YBNXWYVRMHNKPFTBDGQ",type:"person",tags:["people"],updated:"2026-09-05",
...
/* ---------- 02-Products ---------- */
{path:"02-Products/Ciabatta Vialetto.md",title:"Ciabatta Vialetto",id:"01JVTQ8YBNNHWTVGPRDBKXFMQY",type:"product",tags:["product","bread"],updated:"2026-09-05",
...
{path:"02-Products/Rye country loaf.md",title:"Rye country loaf",id:"01JVTQ8YBNTWKDHNPGXBVMFRYQ",type:"product",tags:["product","bread"],updated:"2026-09-05",
...
{path:"02-Products/Almond croissant.md",title:"Almond croissant",id:"01JVTQ8YBNFPRWKGNXHTVDMBQY",type:"product",tags:["product","pastry"],updated:"2026-09-05",
...
{path:"02-Products/Hazelnut tart (old recipe).md",title:"Hazelnut tart (old recipe)",id:"01JVTQ8YBNVYNBXKMDFTPQWRGH",type:"product",tags:["product","pastry"],updated:"2026-09-05",
...
{path:"02-Products/Hazelnut and honey tart.md",title:"Hazelnut and honey tart",id:"01JVTQ8YBNGRXMPKFNBDWHVTYQ",type:"product",tags:["product","pastry","seasonal"],updated:"2026-09-05",
...
/* ---------- 03-Suppliers ---------- */
{path:"03-Suppliers/Mulino Cerrina.md",title:"Mulino Cerrina",id:"01JVTQ8YBNRWTPXFHBDGNVMKQY",type:"supplier",tags:["supplier"],updated:"2026-09-05",
...
{path:"03-Suppliers/Latteria Voss.md",title:"Latteria Voss",id:"01JVTQ8YBNKQDMVXNBGHPWFTRY",type:"supplier",tags:["supplier"],updated:"2026-09-05",
...
{path:"03-Suppliers/Biolievito Kraus.md",title:"Biolievito Kraus",id:"01JVTQ8YBNPFGNQHKRDBWVXMTY",type:"supplier",tags:["supplier"],updated:"2026-09-05",
...
/* ---------- 04-Market ---------- */
{path:"04-Market/Viale Giardini neighbourhood.md",title:"Viale Giardini neighbourhood",id:"01JVTQ8YBNHXTMWVBDNKQRPFGY",type:"place",tags:["market","neighbourhood"],updated:"2026-09-05",
...
{path:"04-Market/Café Lindström.md",title:"Café Lindström",id:"01JVTQ8YBNMXNPBDKGFHVQRTYW",type:"competitor",tags:["market","competitor"],updated:"2026-09-05",
...
{path:"04-Market/Panificio Reale.md",title:"Panificio Reale",id:"01JVTQ8YBNGFVHYKTWNPBDRXMQ",type:"competitor",tags:["market","competitor"],updated:"2026-09-05",
...
{path:"04-Market/Saturday market at Piazza Solari.md",title:"Saturday market at Piazza Solari",id:"01JVTQ8YBNNKBPRHXGDTVWMFQY",type:"event",tags:["market","event"],updated:"2026-09-05",
...
/* ---------- 05-Operations ---------- */
{path:"05-Operations/Baking shifts.md",title:"Baking shifts",id:"01JVTQ8YBNDBPKQNXRWTHVMGFY",type:"operations",tags:["operations"],updated:"2026-09-05",
...
{path:"05-Operations/The wood-fired oven.md",title:"The wood-fired oven",id:"01JVTQ8YBNFMTGVWRBNKXDPQYH",type:"tool",tags:["operations","equipment"],updated:"2026-09-05",
...
{path:"05-Operations/Unsold bread policy.md",title:"Unsold bread policy",id:"01JVTQ8YBNXNHBKTWDGPVRMFYQ",type:"policy",tags:["operations","policy"],updated:"2026-09-05",
...
/* ---------- 06-Decisions ---------- */
{path:"06-Decisions/No delivery policy.md",title:"No delivery policy",id:"01JVTQ8YBNWKDMHBXNPRVQFTGY",type:"decision",tags:["decision"],updated:"2026-09-05",
...
{path:"06-Decisions/Closed on Mondays.md",title:"Closed on Mondays",id:"01JVTQ8YBNHPFTGWXBDKVRNMQY",type:"decision",tags:["decision"],updated:"2026-09-05",
...
{path:"06-Decisions/Organic certification.md",title:"Organic certification",id:"01JVTQ8YBNYQPXVMKGBNDWFTHR",type:"decision",tags:["decision"],updated:"2026-09-05",
...
/* ---------- composed document ---------- */
{path:"_docs/Opening the second shop — brief.md",title:"Opening the second shop — brief",id:"01JVTQ8YBN5PNHGXDBTRYMWKFV",type:"document",tags:["composed-document"],updated:"2026-09-05",
