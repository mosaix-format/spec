...
entities:
  - {name: Café Lindström, type: company}
relations:
  - {from: Café Lindström, type: competes with, to: Forno Vialetto}
links: [Viale Giardini neighbourhood, No delivery policy]
rev: 6d7e8f9a0b1c
---

# Café Lindström

Café Lindström opened in 2017, two years before Forno Vialetto. It serves espresso, industrial croissants and sandwiches, open 6:30 a.m. to 8:00 p.m., seven days a week. Located on the same avenue, about 200 m east. ✅ sourced (observation, 2025-02).
