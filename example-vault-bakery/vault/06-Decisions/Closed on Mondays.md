...
relations: []
links: [Marco Trevisan, Latteria Voss, The wood-fired oven]
rev: 3e4f5a6b7c8d
---

# Closed on Mondays

Monday has been the rest day since opening in 2019. [[Marco Trevisan]] uses it for oven maintenance and ash removal from [[The wood-fired oven]]. Long-fermentation doughs (rye, ciabatta) are mixed on Monday evening for Tuesday's first bake. ✅ sourced (operating plan, 2019-03).
